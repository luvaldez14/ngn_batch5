 ...
 * the bulk copy (bcp) utility in Sybase to dump the records from ngn_recharge.
...
public class NgnGenerateRchgFile {

public static void main(String args[]) {
	PrintWriter out = null;
	int exit_status = 0;
	try {
		out = new PrintWriter(new FileWriter("/tms/ngn/extracts/RECHGBCP"));
		...
		String process_month = period.getStringValue("ngn_period.ngn_period_process_month");
